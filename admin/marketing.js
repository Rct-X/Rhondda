    ...
    result.innerHTML = `
      <div class="status success">
        ...
        <div class="result-actions">
          ...
          <a href="${googleSearch}" target="_blank" class="result-link">Search on Google</a>
          <button class="copy-btn" onclick="navigator.clipboard.writeText('${fullUrl}')">Copy Link</button>
        </div>
